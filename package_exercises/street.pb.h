...
PROTOBUF_NAMESPACE_OPEN
template <>
::my::street::Street* Arena::CreateMaybeMessage<::my::street::Street>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class Street final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:my.street.Street) */ {
 public:
...
inline const std::string& Street::street_name() const {
  // @@protoc_insertion_point(field_get:my.street.Street.street_name)
...
inline PROTOBUF_ALWAYS_INLINE void Street::set_street_name(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:my.street.Street.street_name)
}
inline std::string* Street::mutable_street_name() {
  std::string* _s = _internal_mutable_street_name();
  // @@protoc_insertion_point(field_mutable:my.street.Street.street_name)
  return _s;
}
...
inline std::string* Street::release_street_name() {
  // @@protoc_insertion_point(field_release:my.street.Street.street_name)
...
inline void Street::set_allocated_street_name(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:my.street.Street.street_name)
}
...
inline const ::my::city::City& Street::_internal_city() const {
  const ::my::city::City* p = _impl_.city_;
  return p != nullptr ? *p : reinterpret_cast<const ::my::city::City&>(
      ::my::city::_City_default_instance_);
}
inline const ::my::city::City& Street::city() const {
  // @@protoc_insertion_point(field_get:my.street.Street.city)
...
inline void Street::unsafe_arena_set_allocated_city(
  ...
  _impl_.city_ = city;
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:my.street.Street.city)
}
inline ::my::city::City* Street::release_city() {
...
inline ::my::city::City* Street::unsafe_arena_release_city() {
  // @@protoc_insertion_point(field_release:my.street.Street.city)
  
  ::my::city::City* temp = _impl_.city_;
  _impl_.city_ = nullptr;
  return temp;
}
inline ::my::city::City* Street::_internal_mutable_city() {
...
inline ::my::city::City* Street::mutable_city() {
  ::my::city::City* _msg = _internal_mutable_city();
  // @@protoc_insertion_point(field_mutable:my.street.Street.city)
  return _msg;
}
inline void Street::set_allocated_city(::my::city::City* city) {
  ...
  _impl_.city_ = city;
  // @@protoc_insertion_point(field_set_allocated:my.street.Street.city)
}
