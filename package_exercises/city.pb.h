...
PROTOBUF_NAMESPACE_OPEN
template <>
::my::city::City* Arena::CreateMaybeMessage<::my::city::City>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class City final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:my.city.City) */ {
 public:
  ...
  // int64 zip_code = 2;
  void clear_zip_code() ;
  ::int64_t zip_code() const;
  void set_zip_code(::int64_t value);

  private:
  ::int64_t _internal_zip_code() const;
  void _internal_set_zip_code(::int64_t value);
...
inline const std::string& City::name() const {
  // @@protoc_insertion_point(field_get:my.city.City.name)
...
inline PROTOBUF_ALWAYS_INLINE void City::set_name(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:my.city.City.name)
}
inline std::string* City::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:my.city.City.name)
  return _s;
}
...
inline std::string* City::release_name() {
  // @@protoc_insertion_point(field_release:my.city.City.name)
...
inline void City::set_allocated_name(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:my.city.City.name)
}
...
inline ::int64_t City::zip_code() const {
  // @@protoc_insertion_point(field_get:my.city.City.zip_code)
  return _internal_zip_code();
}
inline void City::set_zip_code(::int64_t value) {
  _internal_set_zip_code(value);
  // @@protoc_insertion_point(field_set:my.city.City.zip_code)
}
inline ::int64_t City::_internal_zip_code() const {
  return _impl_.zip_code_;
}
inline void City::_internal_set_zip_code(::int64_t value) {
  ;
...
inline const std::string& City::country() const {
  // @@protoc_insertion_point(field_get:my.city.City.country)
  return _internal_country();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void City::set_country(Arg_&& arg,
                                                     Args_... args) {
  ;
  _impl_.country_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:my.city.City.country)
}
inline std::string* City::mutable_country() {
  std::string* _s = _internal_mutable_country();
  // @@protoc_insertion_point(field_mutable:my.city.City.country)
  return _s;
}
...
inline std::string* City::release_country() {
  // @@protoc_insertion_point(field_release:my.city.City.country)
  return _impl_.country_.Release();
}
inline void City::set_allocated_country(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:my.city.City.country)
}
