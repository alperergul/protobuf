...
const ::uint32_t TableStruct_building_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
    PROTOBUF_FIELD_OFFSET(::my::building::Building, _internal_metadata_),
    ~0u,  // no _extensions_
    ~0u,  // no _oneof_case_
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::my::building::Building, _impl_.building_name_),
    PROTOBUF_FIELD_OFFSET(::my::building::Building, _impl_.building_num_),
    PROTOBUF_FIELD_OFFSET(::my::building::Building, _impl_.street_),
};

static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        { 0, -1, -1, sizeof(::my::building::Building)},
};

static const ::_pb::Message* const file_default_instances[] = {
    &::my::building::_Building_default_instance_._instance,
};
const char descriptor_table_protodef_building_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    "\n\016building.proto\022\013my.building\032\014street.pr"
    "oto\"Z\n\010Building\022\025\n\rbuilding_name\030\001 \001(\t\022\024"
    "\n\014building_num\030\002 \001(\004\022!\n\006street\030\003 \001(\0132\021.m"
    "y.street.Streetb\006proto3"
};
...
class Building::_Internal {
 public:
  static const ::my::street::Street& street(const Building* msg);
};
...
Building::Building(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:my.building.Building)
}
Building::Building(const Building& from)
  ...
  // @@protoc_insertion_point(copy_constructor:my.building.Building)
}
...
Building::~Building() {
  // @@protoc_insertion_point(destructor:my.building.Building)
...
void Building::Clear() {
// @@protoc_insertion_point(message_clear_start:my.building.Building)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "my.building.Building.building_name"));
        } else {
          goto handle_unusual;
        }
        continue;
...
::uint8_t* Building::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:my.building.Building)
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_building_name().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "my.building.Building.building_name");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:my.building.Building)
  return target;
}

::size_t Building::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:my.building.Building)
  ::size_t total_size = 0;
...
void Building::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:my.building.Building)
...
// @@protoc_insertion_point(class_specific_copy_from_start:my.building.Building)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::my::building::Building*
Arena::CreateMaybeMessage< ::my::building::Building >(Arena* arena) {
  return Arena::CreateMessageInternal< ::my::building::Building >(arena);
}
