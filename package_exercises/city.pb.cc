...
const ::uint32_t TableStruct_city_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
    PROTOBUF_FIELD_OFFSET(::my::city::City, _internal_metadata_),
    ~0u,  // no _extensions_
    ~0u,  // no _oneof_case_
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::my::city::City, _impl_.name_),
    PROTOBUF_FIELD_OFFSET(::my::city::City, _impl_.zip_code_),
    PROTOBUF_FIELD_OFFSET(::my::city::City, _impl_.country_),
};

static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        { 0, -1, -1, sizeof(::my::city::City)},
};

static const ::_pb::Message* const file_default_instances[] = {
    &::my::city::_City_default_instance_._instance,
};
const char descriptor_table_protodef_city_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    "\n\ncity.proto\022\007my.city\"7\n\004City\022\014\n\004name\030\001 "
    "\001(\t\022\020\n\010zip_code\030\002 \001(\003\022\017\n\007country\030\003 \001(\tb\006"
    "proto3"
};
...
City::City(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:my.city.City)
}
City::City(const City& from)
  ...
  // @@protoc_insertion_point(copy_constructor:my.city.City)
}
...
City::~City() {
  // @@protoc_insertion_point(destructor:my.city.City)
...
void City::Clear() {
// @@protoc_insertion_point(message_clear_start:my.city.City)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "my.city.City.name"));
        } else {
          goto handle_unusual;
        }
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 26)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "my.city.City.country"));
        } else {
          goto handle_unusual;
        }
        continue;
...
::uint8_t* City::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:my.city.City)
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_name().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "my.city.City.name");
  ...
  if (!this->_internal_country().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "my.city.City.country");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:my.city.City)
  return target;
}

::size_t City::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:my.city.City)
  ::size_t total_size = 0;
...
void City::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:my.city.City)
...
// @@protoc_insertion_point(class_specific_copy_from_start:my.city.City)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::my::city::City*
Arena::CreateMaybeMessage< ::my::city::City >(Arena* arena) {
  return Arena::CreateMessageInternal< ::my::city::City >(arena);
}
